...
'Causative'=>"${stem}かせる,${stem}かせます,${stem}かせない,${stem}かせません",
'Imperative'=>"${stem}行け,${stem}ってください,${stem}くな,${stem}かないでください",
'Condition'=>"${stem}けば,${stem}かなければ",
'Condition (-tara)'=>"${stem}ったら,${stem}かなかったら",
);
?>