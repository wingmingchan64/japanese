...
'Causative'=>"${stem}らせる,${stem}らせます,${stem}らせない,${stem}らせません",
'Imperative'=>"${stem}れ,${stem}ってください,${stem}るな,${stem}らないでください",
'Condition'=>"${stem}れば,${stem}れなければ",
'Condition (-tara)'=>"${stem}ったら,${stem}らなかったら",
);
?>