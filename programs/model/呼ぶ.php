...
'Causative'=>"${stem}ばせる,${stem}ばせます,${stem}ばせない,${stem}ばせません",
'Imperative'=>"${stem}べ,${stem}んでください,${stem}ぶな,${stem}ばないでください",
'Condition'=>"${stem}べば,${stem}べなければ",
'Condition (-tara)'=>"${stem}んだら,${stem}ばなかったら",
);
?>